...
def wjmm():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            msg.html = '<span>尊敬的</span>'+usermessage.user_name+'，您好：<br>您在旅游景点商品中申请找回密码<br><b style="background-color: #FF0000">重设密码已完成,若非本人操作</b><br>请及时联系管理员修改<b>ganiner@163.com</b>'
            mail.send(msg)
            flash("修改成功")
            db.session.commit()
        except:
